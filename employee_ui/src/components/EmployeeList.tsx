...
import { PlusIcon, PencilIcon, TrashIcon, ArrowUpDownIcon, SearchIcon, FilterIcon, UserIcon, BriefcaseIcon, DollarSignIcon, WrenchIcon } from 'lucide-react';
                ...
                <tr key={employee.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center px-2 py-1 rounded-full text-xs font-semibold">
                      {employee.department === 'HR' && <UserIcon className="h-4 w-4 mr-1 text-purple-500" />}
                      {employee.department === 'IT' && <BriefcaseIcon className="h-4 w-4 mr-1 text-blue-500" />}
                      {employee.department === 'Finance' && <DollarSignIcon className="h-4 w-4 mr-1 text-green-500" />}
                      {employee.department === 'Operations' && <WrenchIcon className="h-4 w-4 mr-1 text-orange-500" />}
                      {employee.department}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
